...
{
"optionName": "SALAM BROTHER BY ⸸ 𝑾𝑨𝑵 ⸸"
}
],
...
.then(({data}) => {
haikal.senwanage(m.chat, data.url, mess.success, m)
})
break
//=================================================//
case 'darkjoke':{
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await haikal.senwanageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
...
let encmedia = await haikal.senwanageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
memek = await haikal.senwanageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
if (anu.status == false) return m.reply(anu.message)
haikal.senwanage(m.chat,anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
...
if (anu.status == false) return m.reply(anu.message)
haikal.senwanage(m.chat, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'fengshui': {
